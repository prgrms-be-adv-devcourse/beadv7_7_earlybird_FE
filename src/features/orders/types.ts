...
// - saga 복구용으로 STOCK_PENDING/PAYMENT_PENDING/PAYMENT_RECONCILIATION_REQUIRED/
//   STOCK_COMPENSATION_PENDING/PAYMENT_COMPENSATION_PENDING이 추가됨
//   (order-service domain/OrderStatus.java 기준).
